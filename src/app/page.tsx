...
// ==========================================
// SUPABASE CLIENT INLINE INITIALIZATION
// ==========================================
...
// ==========================================
// SAMPLE DATA FOR LOCAL / FALLBACK MODE
// ==========================================
...
export default function CommandCenter() {
  ...
  // Form Input States (Reports & Notes)
  ...
  // OPSI B: EDIT TARGET & METRIC STATE
  ...
  // OPSI B: SAVE UPDATED METRIC HANDLER
  ...
  // Submit Handler for Daily Report
  ...
  // Submit Handler for Area Head Notes
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] font-sans pb-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center bg-slate-800 p-1 rounded-lg border border-slate-700">
              ...
              <select
                ...
                className="bg-[#0F172A] text-white text-xs font-semibold rounded px-2 py-1 outline-none border border-slate-600 focus:border-emerald-500"
              >
                <option value="AREA_HEAD">Area Head (Full Read/Write Target & Notes)</option>
                <option value="KEPALA_UNIT">Kepala Unit (Input Laporan)</option>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-8">
        ...
        {/* SECTION 1: EXECUTIVE REGIONAL KPI OVERVIEW */}
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex items-center gap-2 text-xs font-semibold text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 px-3 py-2 rounded-lg shadow-sm transition-all"
            >
        ...
        {/* SECTION 2: UNIT PERFORMANCE TRACKING & MATRIX */}
          ...
          <div className="p-5 border-b border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-50/50">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-slate-700 bg-white border border-slate-300 rounded-lg hover:bg-slate-100 transition-all"
              >
                    ...
                    <tr key={m.id} className="hover:bg-slate-50 transition-colors">
                      <td className="py-3 px-4 font-semibold text-slate-900">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div>{m.unit_name}</div>
                            <div className="text-[10px] text-slate-400 font-normal">{m.unit_code}</div>
                          </div>
                        </div>
                      </td>
                      ...
                      {(currentRole === "AREA_HEAD" || currentRole === "SUPER_ADMIN") && (
                        <td className="py-3 px-4 text-center">
                          <button
                            ...
                            className="p-1.5 text-slate-600 hover:text-emerald-600 hover:bg-emerald-50 rounded transition-all"
        ...
        {/* SECTION 3: DIRECT REPORTING & AREA HEAD NOTES */}
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          
          {/* LEFT COLUMN: FORM INPUT LAPORAN HARIAN (KEPALA UNIT) */}
              ...
              <form onSubmit={handleAddReport} className="space-y-4 pt-2">
                <div>
                  ...
                  <select
                    ...
                    className="w-full text-xs bg-slate-50 border border-slate-300 rounded-lg p-2.5 outline-none focus:border-slate-800"
                  >
                    {INITIAL_UNITS.map((u) => (
                ...
                <button
                  type="submit"
                  className="w-full bg-[#0F172A] hover:bg-slate-800 text-white font-semibold text-xs py-2.5 rounded-lg flex items-center justify-center gap-2 transition-all shadow-sm"
                >
          ...
          {/* RIGHT COLUMN: RECENT REPORTS & AREA HEAD FEEDBACK PANEL */}
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center gap-2">
              ...
              {reports.map((rep) => (
                <div key={rep.id} className="p-3.5 bg-slate-50 rounded-lg border border-slate-200 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] text-slate-400">{rep.report_date}</span>
                  </div>
                  ...
                  {rep.area_head_notes ? (
                    <div className="bg-blue-50 border border-blue-200 p-2.5 rounded-lg text-xs text-blue-900 mt-2">
                      <div className="font-bold flex items-center gap-1 text-[11px] text-blue-700">
                        <CheckCircle2 className="w-3 h-3 text-blue-600" /> Instruksi Area Head:
                      </div>
                      <p className="mt-0.5">{rep.area_head_notes}</p>
                    </div>
                  ) : (
                    (currentRole === "AREA_HEAD" || currentRole === "SUPER_ADMIN") && (
                      <button
                        ...
                        className="mt-2 text-[11px] font-bold text-blue-600 hover:text-blue-800 underline flex items-center gap-1"
                      >
      ...
      {/* OPSI B: MODAL EDIT TARGET & REALISASI METRICS */}
      {editingMetric && (
